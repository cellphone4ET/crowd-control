...
function getDataFromAPI(lat, lng, startDate, endDate) {
  ...
  let settings = {
    ...
    data: {
      ...
      client_secret:
        "ff1ee01bc647aabb41616ad3d3d3d340eb2ed31f38dd732953388a38285cccde"
    },
    dataType: "json",
    type: "GET",
 ...
 bask in your solitude. :)"
  ...
  if (startDate && endDate) {
    settings.data["datetime_local.gt"] = startDate;
    settings.data["datetime_local.lt"] = endDate;
  }
  $.ajax(settings);
}
...
function displayData(events) {
  ...
  let renderedEvents = events.map(function(event) {
    ...
    there will be a large crowd around ${event.venue.address}.<br><br>\
